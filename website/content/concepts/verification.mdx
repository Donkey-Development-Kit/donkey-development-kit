...
| Exchange publish API ([Phase 2](/publishing)) | Unverified | `donkey publish` is blocked; whether Exchange exposes first-class MCP/agent asset types is unconfirmed. |
