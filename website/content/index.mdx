---
description: Governed by the gateway, understood by your code. DDK brings Agent Fabric and Omni Gateway awareness into your agent framework — typed refusals, budgets, telemetry and simulation, with native framework objects.
---
...
<Hero
  eyebrow="Open-source SDK for Agent Fabric"
