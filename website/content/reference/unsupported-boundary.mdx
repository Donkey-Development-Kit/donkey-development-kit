...
Installed framework constructors, MCP API shapes, and descriptor attributes are
checked separately in the verification ledger. Offline package checks do not
establish a live gateway or MCP session and do not remove the discovery, binding,
or descriptor-derivation guards.
