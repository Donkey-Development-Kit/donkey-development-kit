...
<Callout type="info">
  ...
  [Governance](/concepts/governance)). That is a convenience for thin clients
  ...
  per-agent [attribution](/concepts/attribution) unit, and a colon-joined value
...
<Callout type="warning">
  ...
  cannot refresh it — an [asserted conformance exemption](/testing).
</Callout>
