---
description: Three Microsoft Agent Framework scripts — an OpenAIChatClient built by donkey.agent_framework, typed refusals unwrapped from ChatClientException, and the local simulator.
---
...
**Learn more:** [MS Agent Framework](/frameworks/agent-framework)
