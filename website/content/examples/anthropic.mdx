---
description: Two scripts for the native anthropic client from donkey.anthropic.client() — /v1/messages on a Format=Anthropic proxy with last_call, and typed refusals simulated in-process.
---
...
**Learn more:** [Anthropic SDK](/frameworks/anthropic)
