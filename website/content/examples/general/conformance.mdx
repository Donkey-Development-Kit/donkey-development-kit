---
description: pytest --donkey-conformance grading an agent's refusal handling, budget retries and correlation logging — first a naive agent, then the fixed one, then exemptions.
---
...
**Learn more:** [Testing & conformance](/testing)
