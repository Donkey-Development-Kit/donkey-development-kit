...
<Callout type="warning">
  ...
  The refusal path *can* run offline: [Simulating refusals](/examples/general/simulating-refusals)
...
[Gateway identity](/examples/general/gateway-identity)); a run-level record of every call is tracked
...
If the gateway is unavailable, [Framework objects](/examples/general/framework-objects)
