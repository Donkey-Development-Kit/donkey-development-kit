---
description: Two plain-httpx scripts against a Format=Gemini proxy — native generateContent, and an OpenAI-shaped request classified as UpstreamRequestError.
---
...
**Learn more:** [Typed refusals](/errors) · [Model access](/frameworks)
