# Testing & conformance
  ...
  **Phase 1 — both ship.** In-process refusal injection (`donkey.simulate()`)
  ...
  `Donkey` — there is no separate server mode. See [Roadmap](https://donkey-development-kit.github.io/donkey-development-kit/roadmap.md) and
...
| | [Local simulator](https://donkey-development-kit.github.io/donkey-development-kit/simulator.md) | `simulate()` |
|---|---|---|
