...
when you open the page. Phase 1 is complete and released as `donkey-kit`
0.1.0 on [PyPI](https://pypi.org/project/donkey-kit/); Phase 2 is next.
...
## Phase 2 — Differentiate, go beyond
  ...
  **Version 0.2.0 · Goal:** capabilities no generic LLM client offers,
  ...
  review, tool ranking and budget-aware routing. Now that 0.1.0 is published,
